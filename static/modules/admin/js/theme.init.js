/*!
 * 用于当前主题通过的方法
 * Created by liumao801 on 2018-12-07.
 */
...
var lmtheme = function () {
    ...
    showenable = function (val) {
        if (val === 1 || val === "1") {
            ...
            return '<label class="label label-info label-sm"><i class="fa fa-trash"></i> 已删除</label>';
        } else {
            return "未知";
        }
    }
    ...
    showstatus = function (value, texts, css, icon) {
        var index = 0, text = "", icss = 'label-default';
        if (css === null || typeof (css) === 'undefined') {
            css = ['label-warning', 'label-success', 'label-danger', 'label-info', 'label-primary', 'label-default'];
        }
        var item = $(texts).each(function (i, e) {
            if (e.Value === value) {
                index = i;
